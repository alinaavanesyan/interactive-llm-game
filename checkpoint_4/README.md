...
| Алина Аванесян  | Поддержка, расширение и обеспечение безопасности приложения <br> - Эндпоинт `stats` <br> - Миграции БД чере Alembic <br> - реализация JWT-авторизация и проверка прав администратора|
