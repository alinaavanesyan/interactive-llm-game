...
|-----------------|-------------|
| Мария Годунова  | - Эндпоинт `/forward` (POST) для обработки текста <br> - Эндпоинт `/history` (GET) для получения истории запросов <br> - Эндпоинт `/history` (DELETE) для удаления истории запросов <br> - Обработка форматов запросов |
| Алина Аванесян  | - Эндпоинт `stats` <br> - Настройка базы данных и моделей SQLAlchemy <br> - JWT-авторизация |
